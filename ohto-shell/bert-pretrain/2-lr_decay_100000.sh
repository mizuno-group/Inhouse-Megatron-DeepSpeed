...
#PBS -o med_100000_lr_decay.out
#PBS -e med_100000_lr_decay.err
...
jobname="251015_med-bert-full-100000-all-merged-2560_lr_decay"
...
data_path="/work/gg17/a97006/0-250519_modern_bert_0/251004_preprocessed/4_merged/all_merged_100000-1024/4_merged_text_sentence"
vocab_path="/work/gg17/a97006/0-250519_modern_bert_0/251004_tokenizer/vocab_100000.txt"
...
### use ckpt from previous run
checkpoint_path="${output_home}/checkpoint/med-bert-full-100000-all-merged-2560-0.149B-iters-2M-lr-8e-4-min-1e-5-wmup-57000-dcy-2M-sty-constant-gbs-2560-mbs-20-gpu-64-zero-0-mp-1-pp-1-nopp"
save_path="${output_home}/checkpoint/${jobname}"
...
megatron_options=" \
    ...
    --wandb-exp-name 251008_merged_100000_5120 \
