...
#PBS -o preprocess-1.out
#PBS -e preprocess-1.err
...
for dataset_name in ${DATASETS}; do
    ...
    output_prefix_dir="${BASE_DIR}/preprocessed/${dataset_name}/pubmed_50000"
    output_prefix="${output_prefix_dir}/${dataset_name}"
    wandb_name="${DATE_TAG}-miyabi-${dataset_name}-50000"
