...
#PBS -o preprocess_merged-5.out
#PBS -e preprocess_merged-5.err
...
VOCAB_FILE="${BASE_DIR}/251004_tokenizer/vocab_50000.txt"
TOKENIZER_TYPE="BertWordPieceCase"
WORKERS=20
WANDB_PROJECT="med_preprocess"
DATE_TAG="251005_preprocess-5"

echo "=================================================="
echo "Step 1: Preprocessing the merged file..."
echo "=================================================="

OUTPUT_PREFIX_DIR="${BASE_DIR}/251004_preprocessed/pubmed/pubmed_50000-1024"
