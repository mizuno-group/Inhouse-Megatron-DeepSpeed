...
#PBS -o preprocess_merged-10.out
#PBS -e preprocess_merged-10.err
...
VOCAB_FILE="${BASE_DIR}/251004_tokenizer/vocab_100000.txt"
TOKENIZER_TYPE="BertWordPieceCase"
WORKERS=20
WANDB_PROJECT="med_preprocess"
DATE_TAG="251005_preprocess-10"

echo "=================================================="
echo "Step 1: Preprocessing the merged file..."
echo "=================================================="

OUTPUT_PREFIX_DIR="${BASE_DIR}/251004_preprocessed/4_merged/all_merged_100000-1024"
mkdir -p "${OUTPUT_PREFIX_DIR}"
OUTPUT_PREFIX="${OUTPUT_PREFIX_DIR}/pubmed"
WANDB_NAME="${DATE_TAG}"
